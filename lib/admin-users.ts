...
// to one that allows payment. To change which admin maps to which partner,
...
const USERNAME_TO_PARTNER: Record<string, Partner> = {
  Sanyi: "Sanyi",
  Janos: "János",
}

export function paidToForUsername(username: string | null): Partner | null {
  if (!username) return null
  return USERNAME_TO_PARTNER[username] ?? null
}
